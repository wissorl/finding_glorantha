% main.tex
\documentclass[b5paper,10pt,justified]{tufte-book} %estilo tufte, col central más sidenotes
...
\usepackage[margin=1.2cm]{geometry} % apaisado con margen de 1.2
